...
INSERT INTO `city` VALUES ('andong','안동','이제 수정되내@!@#','kr','andong'),('busan','부산','꽃피는 동백섬에 봄이 왔건만형제 떠난 부산항에 갈매기만 슬피 우네오륙도 돌아가는 연락선마다목메어 불러 봐도 대답 없는 내 형제여돌아와요 부산항에 그리운 내 형제여- 조용필, 돌아와요 부산항에.','kr','busan'),('cebu','세부','세부','ph','cebu'),('daegu','대구','대구광역시','kr','daegu'),('jeju','제주','한반도의 남서쪽에 있는 섬. 대한민국의 광역자치단체인 제주특별자치도의 본섬이다. 한국에서 가장 큰 섬이자 인구가 많은 섬으로, 면적은 1833.2㎢, 인구는 약 65만 명이다.','kr','jeju'),('manila','마닐라','마닐라','ph','manila'),('newyork','뉴욕','뉴욕은 미국 북동부, 뉴욕 주의 남쪽 끝에 있는 도시이다. 미국에서 가장 인구가 많은 도시로, 세계에서 가장 인구가 많은 도시 중 하나이다. 세계적인 대도시인 뉴욕은 상업, 금융, 미디어, 예술, 패션, 연구, 기술, 교육, 엔터테인먼트 등 많은 분야에 걸쳐 큰 영향을 끼치고 있으며, 세계의 문화 수도로 불리기도 한다. 이 외에도 뉴욕은 국제 외교에서 중요한 도시이며, 국제 연합 본부가 위치하고 있다.','usa','newyork'),('osaca','오사카','오사카','jp','osaka'),('seoul','서울','서울은 대한민국의 수도이며 과거 백제, 조선의 수도로 시대에 따라 위례성, 한산, 한성, 한양, 양주, 남경, 경성 등 여러 명칭으로 불렸습니다. 암사동 선사주거지를 통해 알 수 있듯 서울은 신석기시대부터 사람들이 거주했고, 삼국시대, 고려, 조선을 거쳐 약 2000년의 역사를 지닌 곳입니다.','kr','seoul'),('tokyo','도쿄','도쿄','jp','tokyo');
...
INSERT INTO `country` VALUES ('ca','캐나다','캐나다','north','canada'),('fi','피지','피지','oceania','fiji'),('fr','프랑스','프랑스','europe','france'),('ja','자메이카','자메이카','south','jameica'),('jp','일본','일본','asia','japan'),('kr','대한민국','대한민국','asia','korea'),('md','몰디브','몰디브','asia','moldives'),('nz','뉴질랜드','뉴질랜드','oceania','new zealand'),('ph','필리핀','필리핀','asia','philippines'),('sp','스페인','스페인','europe','spain'),('tw','대만','대만','asia','taiwan'),('usa','미국','미국','north','USA');
...
INSERT INTO `love` VALUES (13,'김큐아','1'),(16,'큐아큐아','10'),(12,'김큐아','2'),(10,'김큐아','3'),(15,'큐아큐아','7'),(17,'큐아큐아','8'),(16,'susuu','9');
...
INSERT INTO `member` VALUES ('dohauzi@gmail.com','84c45e72ebff7042e000b2bfd67b22367b18ddcb723ce4c32f9f1b2064999e08','김해커','해커만세','여','56679F87612622E091DF7006F09C6805','2017-05-16 14:34:57','basic/woman.png',1,NULL),('gnsgmlckdgk@naver.com','84c45e72ebff7042e000b2bfd67b22367b18ddcb723ce4c32f9f1b2064999e08','황창하','운영자','남','56679F87612622E091DF7006F09C6805','2017-05-04 11:02:03','소율.jpg',0,NULL),('mdnnbm@gmail.com','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','김형주','초천재','남','3C7D42044A9682CF20B24EA10620BF68','2017-05-04 13:51:54','man.png',0,NULL),('min8482@naver.com','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','이승민','농부르기니','남','72F7809922636815ABB1795FF53A3B50','2017-05-10 16:45:04','man.png',0,NULL),('overtimearmy@gmail.com','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','김형주','이미사용중인아이디','남','3C7D42044A9682CF20B24EA10620BF68','2017-05-11 16:36:34','asian-1239271_1280.jpg',1,NULL),('psw607me@naver.com','2ac2a515ee4e98c884697fda61d7f481fb06d724111b4b9a116ad7f1e1781099','박성우','DELL','남','42FCC8F524A9E5A4067437D8B1075AA6','2017-05-08 11:42:49','giphy1.gif',0,1),('rbdk1219@gmail.com','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','김규아','큐아큐아','남','B039F2E630F2431914BCC6E5CD9023AD','2017-05-11 09:44:34','man.png',1,NULL),('rbdk1219@hanmail.net','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','김규아2','큐아큐아2','남','74168209CBF20BD172792846D72114D0','2017-05-11 09:57:45','man.png',1,NULL),('surulru44@naver.com','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','su','susuu','여','BD233029E7E82A8A62981EC63A98751E','2017-05-08 20:07:55','woman.png',0,NULL),('zlxl2723@naver.com','0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c','구민정','alswjd','여','5269AA152A0B6B4CB078668FCD79C418','2017-05-11 11:11:45','woman.png',1,NULL);
...
CREATE TABLE `travel` (
  ...
  CONSTRAINT `travel_ibfk_1` FOREIGN KEY (`country_code`) REFERENCES `country` (`country_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `travel_ibfk_2` FOREIGN KEY (`city_code`) REFERENCES `city` (`city_code`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-05-16 17:22:06
