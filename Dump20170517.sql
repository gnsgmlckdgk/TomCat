...
INSERT INTO `city` VALUES ('andong','안동','경북 중북부에 있는 시. 1896년 13도제가 시행되면서 안동군이 되었고 1963년에는 안동시로 승격했다. 한국 유교문화의 본고장이며 전통문화 유산이 풍부한 고장이다. 봉정사·도산서원·병산서원 등의 유적이 남아있고 하회마을은 2010년 유네스코 세계문화유산에 등재되었다.','kr','andong'),('busan','부산','한반도의 남동부에 있는 대한민국에서 두 번째로 큰 도시. 조선시대와 일제강점기를 거쳐 일본 및 다른 나라들과의 교역창구 역할을 했다. 1960년대에 수출주도형 경제개발이 추진되면서 동아시아의 대표적인 무역항구로 부상하기 시작했다. 우리나라 제1의 국제무역항이자 세계 각국과 연결되는 관문이다.','kr','busan'),('cebu','세부','세부세부세부','ph','cebu'),('daegu','대구','대구대구대구','kr','daegu'),('jeju','제주','대한민국 제주특별자치도 북부에 있는 시. 제주특별자치도의 도청소재지이다. 2006년 북제주군을 통합하면서 인구 증가추세가 이어지고 있다. 용담2동에는 제주국제공항이 있으며, 관광도시의 명성 걸맞게 용두암을 비롯하여 비양도, 비자림, 삼양·이호·협재해수욕장, 한라수목원, 한림공원 등 다양한 관광명소가 곳곳에 산재해있다.','kr','jeju'),('newyork','뉴욕','뉴욕은 미국 북동부, 뉴욕 주의 남쪽 끝에 있는 도시이다. 미국에서 가장 인구가 많은 도시로, 세계에서 가장 인구가 많은 도시 중 하나이다. 세계적인 대도시인 뉴욕은 상업, 금융, 미디어, 예술, 패션, 연구, 기술, 교육, 엔터테인먼트 등 많은 분야에 걸쳐 큰 영향을 끼치고 있으며, 세계의 문화 수도로 불리기도 한다. 이 외에도 뉴욕은 국제 외교에서 중요한 도시이며, 국제 연합 본부가 위치하고 있다.','usa','newyork'),('osaca','오사카','오사카','jp','osaka'),('seoul','서울','한반도의 중서부에 자리하고 있다. 정치·경제·사회·문화와 도로·철도·항공 교통의 중심지이자 구심점이며 세계도시로 발돋움하고 있다. 면적은 605.25㎢로 인구밀도가 매우 높아 인구수가 1,019만 5,318명(2013 추계)에 달한다. ','kr','seoul'),('tokyo','도쿄','도쿄','jp','tokyo');
...
INSERT INTO `love` VALUES (13,'김큐아',1),(12,'김큐아',2),(10,'김큐아',3),(15,'큐아큐아',7),(16,'susuu',9),(16,'큐아큐아',10),(17,'큐아큐아',11),(14,'큐아큐아',12),(13,'큐아큐아',13),(10,'큐아큐아',14);
...
-- Dump completed on 2017-05-17 17:43:05
