...
글쓴이:<input type="text" name="name" value="<%=bb.getNick_name()%>"><br><br>
비밀번호:<input type="password" name="pass"><br><br>
제목:<input type="text" name="subject" value="<%=bb.getSubject()%>"><br><br>
내용:<textarea rows="10" cols="20" name="content"><%=bb.getContent() %></textarea><br><br>
