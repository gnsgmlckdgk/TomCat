...
.text {
	...
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post"
		...
		<input type="hidden" name="cmd" value="_xclick"> <input
			type="hidden" name="business" value="37UUQW9BH8GDA"> <input
			type="hidden" name="custom" value="<%=id%>"> <input
			type="hidden" name="lc" value="GA"> <input type="hidden"
			name="item_name" value="샘플 바로 구매 버튼"> <input type="hidden"
			name="amount" value="0.01"> <input type="hidden"
			name="currency_code" value="USD"> <input type="hidden"
			name="button_subtype" value="services"> <input type="hidden"
			name="no_note" value="0"> <input type="hidden" name="cn"
			value="판매자를 위한 특수 지침을 추가하세요."> <input type="hidden"
			name="no_shipping" value="2"> <input type="hidden" name="rm"
			value="1"> <input type="hidden" name="return"
			value="http://localhost:9080/TomCat/MyPlan.pln?plan_nr=1"> <input
			type="hidden" name="bn"
