...
<div id="combine">
 ...
 %>
			...
			<td><%=qb.getNick()%></td>
			<td><a
				href="./QandAContentAction.qna?num=<%=qb.getNum()%>&pageNum=<%=pageNum%>">
					<%=qb.getSubject()%></a></td>
			<td><%=qb.getDate()%></td>
 ...
 %><a href="./QandAList.qna?pageNum=<%=startPage + pageSize%>">[다음]</a>
	...
	<!-- ========================SEARCH==================== -->
	<div id="table_search">
		<form action="QandASearchAction.qna" method="get" class="search_fr">
	...
	<table id="banner">
		<tr>
			<td><a href="./QandACompanyIntro.qna">회사소개</a></td>
		</tr>
		<tr>
			<td id="darker"><a href="./QandAHowToUse.qna">이용방법</a></td>
		</tr>
		<tr>
			<td><a href="./QandAadvertise.qna">광고 및 제휴</a></td>
		</tr>
		<tr>
			<td id="darker"><a href="./QandAcondition.qna">이용약관</a></td>
		</tr>
		<tr>
...
%>
		...
		<tr>
			<td id="darkerlast"><a href="./QandAList.qna">목록으로</a></td>
		</tr>
