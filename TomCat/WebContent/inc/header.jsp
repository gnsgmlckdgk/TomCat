...
<html>
	<head>
		...
		<!-- 추가한 css -->
			...
			<link rel="stylesheet" href="./assets/css/member/memberManager.css?ver=10"/>
			
			<!-- plan -->
			<link rel="stylesheet" href="./assets/css/plan/planMain.css?ver=20"/>	<!-- 메인페이지 -->
			<link rel="stylesheet" href="./assets/css/plan/planNation.css?ver=19"/>	<!-- 국가페이지 -->
			<link rel="stylesheet" href="./assets/css/plan/planResion.css?ver=19"/>	<!-- 지역(도시)페이지 -->
